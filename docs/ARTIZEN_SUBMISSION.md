...
**Submission Status:** DRAFT (7/8 fields filled; pending: personal video, founder bio, artifact image)  
...
> Personal AI agents that learn from you and prove their growth as NFTs you truly own.

*Character count: ~93 ✓ — fits within 120-char limit.*
...
Covers 1 year of Cloud Run + Firestore + Mantle RPC for ~50 active agents, plus a part-time contributor for documentation & community support.
...
Concept directions (approved by owner — brief designer accordingly):
- **A+B hybrid** — A single AI agent character surrounded by a glowing neural-constellation architecture, with a prominent luminous NFT orb hovering at its core. Dark navy/teal palette. Futuristic, sophisticated, advanced. The orb represents on-chain ownership/proof; the neural constellation represents the agent's learned knowledge. Stylized, clean, no text or logos.
...
9. Team / ask — [PLACEHOLDER: founder name + bio], $7,500 goal, matching-fund opportunity
...
1. ~~Review fundraising goal~~ → $7,500 confirmed
2. ~~Pick artifact concept~~ → A+B hybrid (agent + neural constellation + NFT orb) confirmed
3. Brief a designer with the A+B hybrid concept; get square PNG/JPG ≤10MB, no text/logos
4. Fill in founder bio (name + background) in pitch deck slide 9
5. Record the 30-90 sec personal video (phone is fine)
6. Submit; announce on Discord/X with first-buyer commitment from your network
